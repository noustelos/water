...
const translations = {
  en: {
    ...
    "hero-p": "Construction, Maintenance, and Specialized Chemicals for Pools & Spas. Water Cycle Systems is the official partner of Fluidra S.A. (AstralPool) in the heart of the Cyclades.",
    ...
    "abt-p2": "Water Cycle Systems specializes in the construction and integrated maintenance of swimming pools, hamams, and saunas, offering immediate response and affordable prices. With 24-hour availability and deep knowledge of chemical analysis, we ensure your facility operates flawlessly, winter or summer.",
  ...
  el: {
    ...
    "hero-p": "Κατασκευή, Συντήρηση και Εξειδικευμένα Χημικά για Πισίνες & Spa. Η Water Cycle Systems ειναι ο επίσημος συνεργάτης της Fluidra S.A. (AstralPool) στην καρδιά των Κυκλάδων.",
