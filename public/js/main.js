...
const translations = {
  en: {
    ...
    "faq-a1": "We are based in Santorini and serve villas, hotels and resorts across the island and the wider Cyclades, with local technicians for on-site service.",
    "faq-q2": "What services do you offer?",
    "faq-a2": "Design and construction of pools, jacuzzis, hamams and saunas; seasonal and year-round maintenance; water analysis and chemical balancing; and equipment repair and support.",
    "faq-q3": "What equipment and products do you use?",
    "faq-a3": "As an official Fluidra / AstralPool partner we install professional-grade equipment, balance water with trusted CTX chemicals, and use Zodiac &amp; Polaris cleaning robots, with fast access to original spare parts.",
    "faq-q4": "Do you offer year-round maintenance?",
    "faq-a4": "Yes. We provide both seasonal cover for the busy tourist period and year-round maintenance, keeping every facility clean, safe and guest-ready. We also keep detailed chemical logs so property managers always know the state of their pools.",
    "faq-q5": "How do I request a quote?",
    "faq-a5": "Use the contact form below, email <a href=\"mailto:info@watercyclesystem.gr\" class=\"text-cyan-700 font-semibold hover:underline\">info@watercyclesystem.gr</a>, or call +30 694 207 2531 (mobile) or +30 22860 34132 (landline). Tell us about your property and the support you need and we will reply with a clear next step.",
    "faq-q6": "In which languages can I get support?",
    "faq-a6": "We work in both English and Greek. You can also use the in-page AI assistant for general questions; for confirmed pricing, availability or urgent technical support, contact us directly.",
    ...
    "ft-privacy-link": "Privacy Policy & Cookies",
    "ft-cookie-prefs": "Cookie Preferences",
    "cookie-text": "Our website uses necessary local storage for language and cookie preferences.",
    "cookie-learn": "Learn more",
    "cookie-necessary": "Necessary Only",
    "cookie-accept": "Accept",
    "pp-title": "Privacy & Cookie Policy",
    "pp-updated": "Last updated: May 2026 &nbsp;·&nbsp; Water Cycle System, Santorini, Greece",
    "pp-s1-h": "1. Who we are",
    "pp-s1-p": "<strong class=\"text-primary-400\">Water Cycle System</strong> is a company providing professional pool and spa maintenance services, based in Santorini. You can contact us at <a href=\"mailto:info@watercyclesystem.gr\" class=\"text-primary-400 hover:text-primary-300 transition-colors underline\">info@watercyclesystem.gr</a> or at <a href=\"tel:+306942072531\" class=\"text-primary-400 hover:text-primary-300 transition-colors underline\">+30 694 207 2531</a>.",
    "pp-s2-h": "2. What data we collect",
    "pp-s2-p1": "Through the contact form on our website we collect the following personal data:",
    "pp-s2-ul": "<li>Full name</li><li>Email address</li><li>Phone number (optional)</li><li>Message / request details</li>",
    "pp-s2-p2": "We do not collect payment data or sensitive personal data.",
    "pp-s3-h": "3. Purpose of processing",
    "pp-s3-p1": "The data we collect is used exclusively to:",
    "pp-s3-ul": "<li>Respond to your request and provide a quote/service</li><li>Communicate about the service you requested</li>",
    "pp-s3-p2": "We do not use your data for marketing without your explicit consent.",
    "pp-s4-h": "4. Data sharing",
    "pp-s4-p": "We do not sell or transfer your personal data to third parties. We may use trusted third-party providers, such as an email delivery service for the contact form. If you open the AI chat, your messages are processed by an external Gradio/Hugging Face service so the assistant can work.",
    "pp-s5-h": "5. Cookies",
    "pp-s5-p1": "The website uses only necessary local storage required for its operation:",
    "pp-s5-ul": "<li><strong class=\"text-slate-300\">Necessary cookies:</strong> For the basic operation of the website (e.g. saving language, cookie preference).</li>",
    "pp-s5-p2": "No analytics tools are installed on the website. You can reopen the cookie preferences from the link in the footer.",
    "pp-s6-h": "6. Your rights (GDPR)",
    "pp-s6-p1": "Under Regulation (EU) 2016/679 (GDPR), you have the right to:",
    "pp-s6-ul": "<li>Access your data</li><li>Rectify inaccurate data</li><li>Erasure (“right to be forgotten”)</li><li>Portability of your data</li><li>Object to processing</li>",
    "pp-s6-p2": "For any request, contact us at <a href=\"mailto:info@watercyclesystem.gr\" class=\"text-primary-400 hover:text-primary-300 transition-colors underline\">info@watercyclesystem.gr</a>.",
    "pp-s7-h": "7. Data retention",
    "pp-s7-p": "Contact data is retained for as long as necessary to handle your request and for up to 12 months afterwards, unless you request earlier deletion.",
    "pp-s8-h": "8. Material rights",
    "pp-s8-p": "The images, logo and visual material of the website are used with rights/licence from <a href=\"https://noustelos.gr\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-primary-400 hover:text-primary-300 underline transition-colors\">noustelos.gr</a>.",
    "pp-authority": "For complaints you may contact the Hellenic Data Protection Authority (HDPA): <a href=\"https://www.dpa.gr\" target=\"_blank\" rel=\"noopener\" class=\"text-primary-400 hover:text-primary-300 underline transition-colors\">www.dpa.gr</a>",
    "pp-close": "I understand &amp; Close",
  ...
  el: {
    ...
    "faq-subtitle": "Συχνές Ερωτήσεις",
    "faq-title": "Συχνές Ερωτήσεις",
    "faq-q1": "Σε ποιες περιοχές δραστηριοποιείστε;",
    "faq-a1": "Εδρεύουμε στη Σαντορίνη και εξυπηρετούμε βίλες, ξενοδοχεία και resorts σε όλο το νησί και στις ευρύτερες Κυκλάδες, με τοπικούς τεχνικούς για εξυπηρέτηση επιτόπου.",
    "faq-q2": "Τι υπηρεσίες προσφέρετε;",
    "faq-a2": "Σχεδιασμό και κατασκευή πισινών, jacuzzi, χαμάμ και σάουνας· εποχιακή και ετήσια συντήρηση· ανάλυση νερού και χημική ισορροπία· καθώς και επισκευή και υποστήριξη εξοπλισμού.",
    "faq-q3": "Τι εξοπλισμό και προϊόντα χρησιμοποιείτε;",
    "faq-a3": "Ως επίσημος συνεργάτης Fluidra / AstralPool εγκαθιστούμε επαγγελματικό εξοπλισμό, ρυθμίζουμε τη χημική ισορροπία με αξιόπιστα προϊόντα CTX και χρησιμοποιούμε ρομπότ καθαρισμού Zodiac &amp; Polaris, με γρήγορη πρόσβαση σε γνήσια ανταλλακτικά.",
    "faq-q4": "Προσφέρετε ετήσια συντήρηση;",
    "faq-a4": "Ναι. Παρέχουμε τόσο εποχιακή κάλυψη για την τουριστική περίοδο όσο και ετήσια συντήρηση, ώστε κάθε εγκατάσταση να παραμένει καθαρή, ασφαλής και έτοιμη για επισκέπτες. Τηρούμε επίσης αναλυτικά χημικά αρχεία, ώστε οι διαχειριστές να γνωρίζουν πάντα την κατάσταση των πισινών τους.",
    "faq-q5": "Πώς ζητάω προσφορά;",
    "faq-a5": "Χρησιμοποιήστε τη φόρμα επικοινωνίας παρακάτω, στείλτε email στο <a href=\"mailto:info@watercyclesystem.gr\" class=\"text-cyan-700 font-semibold hover:underline\">info@watercyclesystem.gr</a> ή καλέστε στο +30 694 207 2531 (κινητό) ή +30 22860 34132 (σταθερό). Πείτε μας για το ακίνητό σας και την υποστήριξη που χρειάζεστε και θα απαντήσουμε με ένα σαφές επόμενο βήμα.",
    "faq-q6": "Σε ποιες γλώσσες μπορώ να εξυπηρετηθώ;",
    "faq-a6": "Εργαζόμαστε στα Αγγλικά και στα Ελληνικά. Μπορείτε επίσης να χρησιμοποιήσετε τον AI βοηθό της σελίδας για γενικές ερωτήσεις· για επιβεβαιωμένες τιμές, διαθεσιμότητα ή επείγουσα τεχνική υποστήριξη, επικοινωνήστε απευθείας μαζί μας.",
    ...
    "ft-privacy-link": "Πολιτική Απορρήτου & Cookies",
    "ft-cookie-prefs": "Προτιμήσεις Cookies",
    "cookie-text": "Ο ιστότοπός μας χρησιμοποιεί απαραίτητες τοπικές αποθηκεύσεις για τη γλώσσα και τις προτιμήσεις cookies.",
    "cookie-learn": "Μάθετε περισσότερα",
    "cookie-necessary": "Μόνο τα Απαραίτητα",
    "cookie-accept": "Αποδοχή",
    "pp-title": "Πολιτική Απορρήτου & Cookies",
    "pp-updated": "Τελευταία ενημέρωση: Μάιος 2026 &nbsp;·&nbsp; Water Cycle System, Σαντορίνη, Ελλάδα",
    "pp-s1-h": "1. Ποιοι είμαστε",
    "pp-s1-p": "Η <strong class=\"text-primary-400\">Water Cycle System</strong> είναι εταιρεία παροχής επαγγελματικών υπηρεσιών συντήρησης πισίνας και spa, με έδρα τη Σαντορίνη. Μπορείτε να επικοινωνήσετε μαζί μας στο <a href=\"mailto:info@watercyclesystem.gr\" class=\"text-primary-400 hover:text-primary-300 transition-colors underline\">info@watercyclesystem.gr</a> ή στο <a href=\"tel:+306942072531\" class=\"text-primary-400 hover:text-primary-300 transition-colors underline\">+30 694 207 2531</a>.",
    "pp-s2-h": "2. Ποια δεδομένα συλλέγουμε",
    "pp-s2-p1": "Μέσω της φόρμας επικοινωνίας του ιστότοπού μας συλλέγουμε τα εξής προσωπικά δεδομένα:",
    "pp-s2-ul": "<li>Ονοματεπώνυμο</li><li>Διεύθυνση ηλεκτρονικού ταχυδρομείου (email)</li><li>Αριθμός τηλεφώνου (προαιρετικό)</li><li>Μήνυμα / Λεπτομέρειες αιτήματος</li>",
    "pp-s2-p2": "Δεν συλλέγουμε δεδομένα πληρωμής ούτε ευαίσθητα προσωπικά δεδομένα.",
    "pp-s3-h": "3. Σκοπός επεξεργασίας",
    "pp-s3-p1": "Τα δεδομένα που συλλέγουμε χρησιμοποιούνται αποκλειστικά για:",
    "pp-s3-ul": "<li>Απάντηση στο αίτημά σας και παροχή προσφοράς/υπηρεσίας</li><li>Επικοινωνία σχετικά με την υπηρεσία που ζητήσατε</li>",
    "pp-s3-p2": "Δεν χρησιμοποιούμε τα δεδομένα σας για marketing χωρίς ρητή συγκατάθεσή σας.",
    "pp-s4-h": "4. Διαμοιρασμός δεδομένων",
    "pp-s4-p": "Δεν πωλούμε ούτε εκχωρούμε τα προσωπικά σας δεδομένα σε τρίτους. Ενδέχεται να χρησιμοποιούμε αξιόπιστους τρίτους παρόχους, όπως υπηρεσία αποστολής email για τη φόρμα επικοινωνίας. Αν ανοίξετε το AI chat, τα μηνύματά σας επεξεργάζονται από εξωτερική υπηρεσία Gradio/Hugging Face ώστε να λειτουργήσει ο βοηθός.",
    "pp-s5-h": "5. Cookies",
    "pp-s5-p1": "Ο ιστότοπος χρησιμοποιεί μόνο απαραίτητες τοπικές αποθηκεύσεις για τη λειτουργία του:",
    "pp-s5-ul": "<li><strong class=\"text-slate-300\">Απαραίτητα cookies:</strong> Για τη βασική λειτουργία του ιστότοπου (π.χ. αποθήκευση γλώσσας, προτίμηση cookies).</li>",
    "pp-s5-p2": "Δεν έχουν εγκατασταθεί εργαλεία analytics στον ιστότοπο. Μπορείτε να ανοίξετε ξανά τις προτιμήσεις cookies από τον σύνδεσμο στο υποσέλιδο.",
    "pp-s6-h": "6. Τα δικαιώματά σας (GDPR)",
    "pp-s6-p1": "Βάσει του Κανονισμού (ΕΕ) 2016/679 (GDPR), έχετε δικαίωμα:",
    "pp-s6-ul": "<li>Πρόσβασης στα δεδομένα σας</li><li>Διόρθωσης ανακριβών δεδομένων</li><li>Διαγραφής («δικαίωμα στη λήθη»)</li><li>Φορητότητας των δεδομένων σας</li><li>Εναντίωσης στην επεξεργασία</li>",
    "pp-s6-p2": "Για οποιοδήποτε αίτημα, επικοινωνήστε μαζί μας στο <a href=\"mailto:info@watercyclesystem.gr\" class=\"text-primary-400 hover:text-primary-300 transition-colors underline\">info@watercyclesystem.gr</a>.",
    "pp-s7-h": "7. Διατήρηση δεδομένων",
    "pp-s7-p": "Τα δεδομένα επικοινωνίας διατηρούνται για όσο διάστημα είναι απαραίτητο για τη διεκπεραίωση του αιτήματός σας και για έως 12 μήνες μετά, εκτός εάν ζητήσετε τη διαγραφή τους νωρίτερα.",
    "pp-s8-h": "8. Δικαιώματα υλικού",
    "pp-s8-p": "Οι εικόνες, το λογότυπο και το οπτικό υλικό του ιστότοπου χρησιμοποιούνται με δικαιώματα/παραχώρηση από <a href=\"https://noustelos.gr\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-primary-400 hover:text-primary-300 underline transition-colors\">noustelos.gr</a>.",
    "pp-authority": "Για καταγγελίες μπορείτε να απευθυνθείτε στην Αρχή Προστασίας Δεδομένων Προσωπικού Χαρακτήρα (ΑΠΔΠΧ): <a href=\"https://www.dpa.gr\" target=\"_blank\" rel=\"noopener\" class=\"text-primary-400 hover:text-primary-300 underline transition-colors\">www.dpa.gr</a>",
    "pp-close": "Κατανοώ &amp; Κλείνω",
