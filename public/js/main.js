...
const translations = {
  en: {
    ...
    "cnt-title": "Ready to prepare your pool for the season?",
    "cnt-desc": "Contact our local Santorini team for a technical audit or maintenance quote.",
  ...
  el: {
    ...
    "cnt-title": "Έτοιμοι να προετοιμάσετε την πισίνα σας για τη σεζόν;",
    "cnt-desc": "Επικοινωνήστε με την τοπική ομάδα μας στη Σαντορίνη για τεχνικό έλεγχο ή προσφορά συντήρησης.",
